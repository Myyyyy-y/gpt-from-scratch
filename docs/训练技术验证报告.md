...
- **多 seed 显著性**（冠军组 seed 1/2/3）：best val 均值 **1.3771 ± 0.0108**（单次 1.3668, 1.3761, 1.3883；对照 seed=0 冠军 1.3832）
- **29M GPU 版 KV cache 复测**：RTX 4090 / bf16 下 52.29 → 54.79 tok/s（**1.05×**），验证小模型 GPU 上收益被 kernel 启动开销稀释（见 `docs/kv_cache测试.md`）

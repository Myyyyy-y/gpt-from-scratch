...
- **32 个单元测试全绿**：手写组件 vs PyTorch 官方实现的数值对照
...
- 已完成：位置编码消融、2-epoch 重训（best 1.3212，见 `docs/训练技术验证报告.md`）
- 待做：29M GPU 版 KV cache 复测（`docs/kv_cache测试.md` 表格中仍留空）、
  归一化/数据量消融、技术组合实验
- 二期方向（参考项目 H 的 ass2 内容）：Triton FlashAttention、DDP 多卡训练

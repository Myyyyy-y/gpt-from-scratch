...
## Goal
消除文档遗留的混淆变量：008 的 QK 组使用 min_lr=3e-4，冠军组为 3e-5，
"QK 未超冠军"无法干净归因。本组使用与冠军完全相同的配置（lr 1e-3 / min_lr 3e-5），
...
## Conclusions
**QK-Norm 在冠军配置下确有真实收益**：1.3746 < 1.3832（-0.0086），且训练全程
稳定（gnorm ≤ 0.4）。文档中"QK 未超冠军"的旧结论系 min_lr 混淆所致，干净归因
